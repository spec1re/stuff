...
# pkg lock pkg
pkg update
pkg install mailscanner bash dcc-dccd spamassassin p7zip rsync p5-Geo-IP razor-agents p5-LWP-UserAgent-WithCache p5-Net-Patricia py36-pyzor p5-Encoding-FixLatin p5-Test-Pod p5-Mail-ClamAV p5-Mail-SPF p5-Module-Build p5-YAML
